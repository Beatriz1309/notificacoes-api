...
/*
 Grencia o array de eventos
 tem funcções com nomes claros (listarTodos, buscarPorld, etc.)
 Exporta as funcções para que outros arquivos possam usar
 NÃO usa req, res, status, json -- isso pe trabalho do Controller
 */